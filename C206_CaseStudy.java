...
public class C206_CaseStudy {
	...
	public static void main(String[] args) {
		...
		quotationList.add(d);
		//OPTION 4
		ManageQuotation mq = new ManageQuotation(132546, 523145, "Hall", "Tiles", "Alan", "12/02/2022", 2000);
		manageList.add(mq);
		// OPTION 5
...
/*		public static Quotation requestQuotation(ArrayList<Quotation> quotationList) {
		...
		public static void deleteQuotation(ArrayList<Quotation> quotationList) {
			String rID = Helper.readString("Enter request ID to delete > ");
			...
			for (int i = 0; i < quotationList.size(); i++) {
				...
				if (rID.equals(a)) {
					...
					System.out.println("Successfully deleted request ID: " + rID);
				} else {
...
//=====================================================================Option 4 -complete==============================================================================
		public static String retrieveAllManageQuotation(ArrayList<ManageQuotation> manageList) {
			        ...
			        for (int i = 0; i < manageList.size(); i++) {
			            output += String.format("%-103s", manageList.get(i).toString());
			        }
			        return output;
			    }
		...
		public static String retrieveAllAppointment(ArrayList<Appointment> appointmentList) {
			...
			for(int i  = 0; i < appointmentList.size(); i++) {
				...
				output += String.format("%-10s %-20s %-20s %-20s %-10s\n", name , 
						...
						appointmentList.get(i).getTime(), appointmentList.get(i).getAddress()) ;
			}
			return output;
		}
